Sub quarter_pt1()
    ...
    For Each ws In Worksheets
        ...
        ' Reset table row for next sheet
        Table_Row = 2

        ' Calculate the Maximum Value in column K
        MaxValue = Application.WorksheetFunction.Max(ws.Range("K2:K" & LastRow))
        
        ' Find the row of the Maximum Value using a loop
        For i = 2 To LastRow
        ...
        ' Calculate the Maximum Total Stock Volume in column L
        MaxTotalValue = Application.WorksheetFunction.Max(ws.Range("L2:L" & LastRow))

        ' Find the row of the Maximum Total Value using a loop
        For i = 2 To LastRow
